...
class Table {
 ...
 private:
   ...
   ListType* table; //the dynamic array for ListType object
   int numofEntries; //the variable to count the number of entries
   int getNonEmpty() const; //helper function to count the number of non-empty bucket
   int getLongestChain() const; //helper function to find the longest chain
